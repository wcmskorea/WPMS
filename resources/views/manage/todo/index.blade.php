      ...
      <div class="col">
        ...
        <div class="box box-danger">
          ...
          <div class="box-footer clearfix no-border">
            <button type="button" class="btn btn-primary pull-right" id="addNewTodo" data-toggle="modal" data-target="#modal-todo" title="Alt + N" accesskey="n"><i class="fa fa-plus"></i>&nbsp;&nbsp;할일 추가하기</button>
          </div>
        </div><!-- /.box -->
      </div><!-- /.col -->
      <div class="col">

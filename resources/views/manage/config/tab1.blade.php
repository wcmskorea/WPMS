    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="{{ route('manage.config.show', 2) }}">2. 테마 정보</a></li>
                ...
                <div class="tab-pane active">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="filterwords" id="textFilter" class="form-control" rows="5" placeholder="Enter ...">{{ $configWebsite['filterwords'] }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="ipallow" id="textAllow" class="form-control" rows="3" placeholder="ex) 127.0.0,1111.222.333.444,000.000.000.000">{{ $configWebsite['ipallow'] }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="ipdeny" id="textDeny" class="form-control" rows="3" placeholder="ex)  127.0.0,1111.222.333.444,000.000.000.000">{{ $configWebsite['ipdeny'] }}</textarea>
